...
void menu_switch(int counter, double height, double box1, double box2);
void programs(double height, bool set, bool rand_set, int percentage);
...
void loop() {
    ...
    if (!calibrated) {//Initial calibration if it hasn't been done before
        ...
        if (digitalRead(btn) == LOW) {
            menu_switch(counter, height, box1, box2);
        }
...
void menu_switch(int counter, double height, double box1, double box2) {
    ...
    if (tank1.measureDistanceCm() > 22) {
        ...
        case 0:
            ...
            break;
        case 1:
            programs(height, true, false, 10);
            break;
        case 2:
            programs(height, true, false, 20);
            break;
        case 3:
            programs(height, true, false, 30);
            break;
        case 4:
            programs(height, false, true, 0);
            break;
        case 5:
            programs(height, false, false, 0);
            break;
        case 6:
            calibration_print(height, box1, box2);
            break;
...
void calibration_print(double height, double box1, double box2) {
    double arr[] = {
        height,
        box1,
        box2
